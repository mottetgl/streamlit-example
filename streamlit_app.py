...
st.title('Traditional Medicare Physician Anomalies')
...
if checked:
  active_specialties = pr_phys.specialty.sort_values().unique()
...
with st.expander("Show Anomaly Details (Single Provider)"):
  ...
  c1.subheader('Total Allowed:  $%{pr_phys_one.total_allowed:,.0f}')
